...
1. Professor [Name], [Department]
   Research: [area]
   Recent paper: [title]
   Connection: [how it links to Project 07]
   Email: [email]
   Status: [ ] Not emailed [ ] Emailed [ ] Replied

### Nearby IITs/IIITs
2. Professor: Pradyot Anand, Indian Institute of Technology, Delhi, India
    Department: Bharti School of Telecommunication
    Email: pradyotanand282@gmail.com
    Status: [ ] Not emailed [✅] Emailed [ ] Replied
    ...
    EEG and BCI together which is hard to find.
    So I'll request each one of them to first endorse me so i can publish my paper on 'arxiv'.

 


## Email schedule
Week 9: Email professors 1, 2, 3
Week 10: Email professors 4, 5, 6
